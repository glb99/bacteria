"""Persistence for the entities in :mod:`fastpaip.models`.
...
from fastpaip.models import User, UserCreate, UserId
...
class UserRepository:
    ...
    :mod:`fastpaip.core.protocols` structurally — it inherits nothing and
