...
called now" — that is :mod:`bacteria.agent.tools.approval` — and it cannot call
anything itself — that is :mod:`bacteria.agent.tools.execution`. Describing a
...
class ToolRegistry:
    ...
    def register(self, tool: ToolDefinition) -> None:
        ...
        (:mod:`bacteria.agent.interfaces.cli`), and worth revisiting if it does not.
        """
