...
Splitting them shows up concretely in :mod:`bacteria.agent.model.errors`, where the
...
:mod:`bacteria.agent.tools`, which is what makes that a structural guarantee rather
than a rule someone has to remember.

Start at :mod:`bacteria.agent.model.protocol` — it defines the contract both clients
