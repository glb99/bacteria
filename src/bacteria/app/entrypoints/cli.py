...
from bacteria.app.provider.gemini_client import GeminiClient
from bacteria.app.store.in_memory.in_memory_session_repository import (
...
def build_model_client(provider: str | None = None) -> SendsMessages:
    ...
    """
    name = (provider or os.getenv("MODEL_PROVIDER",
    ...
    try:
        ...
        raise ValueError(
            f"unknown MODEL_PROVIDER {name!r}; expected one of: {known}") from None
    return client_cls()
