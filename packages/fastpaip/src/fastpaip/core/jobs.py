...
def _pool_factory(**kwargs: Any) -> psycopg_pool.AsyncConnectionPool:
    ...
    The indirection exists to keep a promise :mod:`fastpaip.core.settings`
...
def register_tasks() -> App:
    ...
    """
    from fastpaip.ingestion import tasks as _ingestion_tasks  # noqa: F401
