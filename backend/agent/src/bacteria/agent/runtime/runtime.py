...
:mod:`bacteria.agent.context.assembly`, the model call to a
:class:`~bacteria.agent.model.protocol.SendsMessages` implementation, tool execution
to :mod:`bacteria.agent.tools.execution`, and every state write to a
:class:`~bacteria.agent.session.protocol.SessionRepository`. It reimplements none of
them.
...
from bacteria.agent.tools.execution import (
    Approve,
    ToolExecutionError,
    ToolResult,
    execute_tool_call,
...
class Runtime:
    ...
    Args:
        model_client: Anything satisfying
            :class:`~bacteria.agent.model.protocol.SendsMessages`. The runtime is
        ...
        session_store: Anything satisfying
            :class:`~bacteria.agent.session.protocol.SessionRepository`. The runtime
