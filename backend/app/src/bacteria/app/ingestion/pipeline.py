...
:class:`~bacteria.app.core.adapters.FunctionalProcessor` and hosted by a
:class:`~bacteria.app.core.handlers.StepHandler`. None of them import each other or
...
from bacteria.app.core.handlers import Handler, StepHandler
